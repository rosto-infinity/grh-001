             ...
             <div class="small-box bg-info">
               <div class="inner">
                <a href="{{ route('admin.employees') }}">
                 <h2 class="text-white"> {{ $employees->count() }} </h2>
               ...
               <a href="{{ route('admin.employees') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
             </div>
           </div>
           <!-- ./col -->
           <div class="col-lg-3 col-6">
               ...
               <div class="card-body">
                 ...
                 <div class="direct-chat-contacts">
                   <ul class="contacts-list">
                     ...
                     <li>
                       <a href="#">
                         <img class="contacts-list-img" src="{{asset('ist/img/user5-128x128.jpg')}}d" alt="User Avatar">
